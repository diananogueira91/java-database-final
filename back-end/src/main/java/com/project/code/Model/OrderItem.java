...
//    - Apply @JsonManagedReference (corrected to @JsonBackReference) to manage bidirectional relationships and JSON serialization.
    @ManyToOne
...
//    - Apply @JsonManagedReference (corrected to @JsonBackReference) to prevent circular references during JSON serialization.
    @ManyToOne
